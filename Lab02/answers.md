...
it changes by the subtraction which updates the condition flags
...
|    01010100      |   111111111111111110100    | 0  |   0001   |

- `imm19` (binary) = 111111111111111110100
- `imm19` as a two's complement integer = -6
- Byte offset (imm19 × 4) = -24 bytes
...
## Section 4.1 — Logical Immediate Values - DONT WORRY ABOUT
